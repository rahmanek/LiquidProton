			...
			_cdn.React.createElement(
				...
				_cdn.React.createElement(
					...
					_cdn.React.createElement(
						'div',
						{ className: 'col-xs-6' },
						_cdn.React.createElement('i', { className: 'fa fa-share-alt', onClick: function onClick() {
					...
					_cdn.React.createElement(
						'div',
						null,
						_cdn.React.createElement('i', { className: 'fa fa-bars', onClick: function onClick() {
								return _this2.toggleCollapse("exCollapsingNavbar");
							} })
					)
				)
			),
